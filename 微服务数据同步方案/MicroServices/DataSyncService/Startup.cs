...
namespace DataSyncService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DataSyncService", Version = "v1", Description = "微服务01" });
                ...
                var sawgger_xml = Path.Combine(basePath, "DataSyncService.xml");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IHostApplicationLifetime lifetime)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DataSyncService v1"));
